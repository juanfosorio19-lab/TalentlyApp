...
8. **Pasos de onboarding**: El onboarding de candidato tiene 12 pasos (no 16). El de empresa tiene 10 pasos: SIN paso de tipo (la selección candidato/empresa existe UNA sola vez — paso 1 del wizard de candidato) y SIN paso de stack tecnológico (se pide al crear ofertas de área TI). Los pasos fantasma NO existen.
