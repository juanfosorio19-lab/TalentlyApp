...
file_path = r'c:\Users\Juan Osorio\Talently-Project\js\app.js'

# 1. Read the Safe Header (Lines 1-2390)
with open(file_path, 'r', encoding='utf-8') as f:
    lines = f.readlines()

safe_header = "".join(lines[:2390])

# 2. Define the Fixed Tail
fixed_tail = """// ===== CANDIDATE SEARCH LOGIC APPENDED =====
Object.assign(app, {
    searchCandidates() {
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(safe_header + fixed_tail)

print("Done. Restored app.js")
